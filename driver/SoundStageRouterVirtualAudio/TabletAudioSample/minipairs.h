...
Abstract:
    ...
    Reduced from the upstream TabletAudioSample endpoint matrix to one internal
    render endpoint with loopback support. Capture endpoints, HDMI/SPDIF,
    headphone variants, keyword detection, and sideband transport endpoints are
    intentionally omitted from this trimmed slice.
...
{
    eSpeakerDevice,
    L"TopologySoundStageRouter51",
    NULL,
    CreateMiniportTopologySYSVAD,
    &SpeakerTopoMiniportFilterDescriptor,
    0, NULL,
    L"WaveSoundStageRouter51",
    NULL,
    CreateMiniportWaveRTSYSVAD,
